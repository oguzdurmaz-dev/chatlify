...
export default function Button({ onClick = null, children = null }) {
  return (
    <>
      <button
        className={`${styles.button} rounded shadow-button pl-6 pr-8 py-3 bg-white hover:bg-gray-50 text-gray-600 font-medium flex items-center justify-center overflow-y-hidden focus:outline-none focus:ring focus:ring-primary-500 focus:ring-opacity-75`}
        onClick={onClick}
      >
        <svg
          viewBox="5 -5 30 30"
